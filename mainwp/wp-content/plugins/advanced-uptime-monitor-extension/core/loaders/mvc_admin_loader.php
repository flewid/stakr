...
class MvcAdminLoader extends MvcLoader {
	...
	public function admin_init() {
		if ( (has_filter( 'mainwp_currentusercan' ) && mainwp_current_user_can( 'extension', 'advanced-uptime-monitor-extension' )) or
			( ! has_filter( 'mainwp_currentusercan' ) && current_user_can( 'manage_options' ) ) ) {
